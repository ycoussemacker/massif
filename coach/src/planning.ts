 ...
 *  Pure (date helpers passed in so it imports no DB). MIRROR of web/src/lib/planning.ts — keep in sync. */
import { projectFromMetrics, type DayLoad, type SeedMetric } from "./project.js";
